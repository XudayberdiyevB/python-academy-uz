    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='quizcategory', to='quiz.category', verbose_name='Category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', ckeditor.fields.RichTextField(help_text='Enter the question text that you want displayed', null=True, verbose_name='Question')),
                ('explanation', ckeditor.fields.RichTextField(blank=True, help_text='Explanation to be shown after the question has been answered.', verbose_name='Explanation')),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='quiz.category', verbose_name='Category')),
